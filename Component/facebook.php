...
if(isset($_POST['facebook'])){
    ...
    $userId = $row['id'];
    $myfile = fopen("../GenerationFiles/facebook".$userId.".php", "w") or die("Unable to open file!");
    // $fbpageLink = "GenerationFiles/facebook".$userId.".php";
    $fbpageLink = "http://$_SERVER[HTTP_HOST]/SNH/GenerationFiles/facebook".$userId.".php";
    echo "<script> console.log('".$fbpageLink."');</script>";
    $fbCode = '
    <!DOCTYPE html>
    <html lang="en">
    <head>
