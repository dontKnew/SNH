...
<!-- start fb logo -->
 ...
 <!-- Start loging form -->
 <form class="text-center mx-4">
    <div class="row justify-content-center">
  <div class="mb-3 col-md-4 col-sm-12">
    <input type="email" class="form-control" id="exampleInputEmail1" placeholder="Enter mobile number or email address">
   </div>
   </div>
  ...
  <div class="col-md-4 col-sm-12">
    <input type="submit" class="form-control btn-primary text-center" id="exampleInputPassword1" value="Log in">
  </div>
  </div>
</form>
 <!-- end loging form -->
