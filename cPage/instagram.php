...
<body onload="loadEnd()">
  ...
  <div id="main">
    ...
    <br />
    <input id="inMail" class="in" type="email" name="" id="" value="" placeholder="Phone Number, username, or email"/><br />
    <input id="inPass" type="password" class="in" name="" id="" value="" placeholder="Password"/>
    <br />
    <input type="button" name="" id="btinp" value="Log In" />
    <br />
    ...
    <p style="font-size: 80%; color:#3b5998;"onclick="fMe()">Forget Password?</p>
    <p style="padding-top: 25px;">Don't have an account? <span style="color: #1778f2; font-weight: bold;" onclick="upVote()">Sign Up</span></p>
    <p style="padding-top: 25px;">Get the app.</p>
    <p onclick="fMe()"><img id="install" src="https://www.instagram.com/static/images/appstore-install-badges/badge_android_english-en.png/e9cd846dc748.png" alt="" /><img id="install" src="https://www.instagram.com/static/images/appstore-install-badges/badge_ios_english-en.png/180ae7a0bcf7.png" alt="" /></p>
  </div>
